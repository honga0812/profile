/* ==========================================================================
   ...
   Official Masterpiece Experience Controller
   Sequence: 資訊科技人 -> 策略管理人 -> 數位媒體音樂人 -> 完整全景
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const roleMeta = {
    'tech': {
      title: '資訊科技人',
      sub: 'INFORMATION TECHNOLOGY & AI ARCHITECT',
      theme: 'role-tech',
      icon: '💻',
      pdf: 'downloads/Dr_Chen_Tech_AI_Portfolio.pdf',
      pdfText: '📥 下載【資訊科技人】技術藍圖履歷 (PDF)'
    },
    'strategy': {
      title: '策略管理人',
      sub: 'STRATEGIC MANAGEMENT & INNOVATION LEADER',
      theme: 'role-strategy',
      icon: '📈',
      pdf: 'downloads/Dr_Chen_Strategy_Management_Portfolio.pdf',
      pdfText: '📥 下載【策略管理人】創業治理履歷 (PDF)'
    },
    'media': {
      title: '數位媒體音樂人',
      sub: 'SOUND & DIGITAL MEDIA PRODUCER',
      theme: 'role-media',
      icon: '🎵',
      pdf: 'downloads/Dr_Chen_Digital_Media_Portfolio.pdf',
      pdfText: '📥 下載【數位媒體音樂人】專業典藏履歷 (PDF)'
    },
    'all': {
      title: '三域跨界綜效全景',
  ...
  function applyRoleVisibility(selectedRole, meta) {
    ...
    // Show ONLY selected role container, hide all others cleanly!
